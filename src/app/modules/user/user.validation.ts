...
const parseDoctorObject = (value: unknown): unknown => {
    ...
    .union([
      ...
      z.object({
        ...
        appointmentFee: z
          ...
          .min(100, "Appointment fee must be at least ৳100 to meet Stripe minimum charge requirement"),
